...
@Slf4j
public class AgregaFunko extends JFrame {
    ...
    public AgregaFunko(JFrame parent) {
        this.parentForm = parent;
        this.client = new FunkoClient(new RestClient());
        log.info("AgregarFunko opened");
        this.setTitle("Agregar Funko");
    ...
    private void guardaFunko() {
        ...
        log.info("Validation successfully passed. Creating funko");
        boolean saved = this.client.saveFunko(
                FunkoDto.builder()
        ...
        if (saved) {
            confirmation = JOptionPane.showConfirmDialog(this, "Funko guardado " +
                            "exitosamente. ¿Desea guardar otro Funko en la colección?",
                    "Funko guardado", JOptionPane.YES_NO_OPTION);
            this.clearFields();
        } else {
    ...
    private void clearFields() {
        ...
        this.cbxTamanio.setSelectedIndex(0);
